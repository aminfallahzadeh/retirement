...
function BaseRetirementBenefitsGrid() {
  const [rowSelection, setRowSelection] = useState({});

  const columns = useMemo(
    () => [
      {
        accessorKey: "benefitsRow",
        header: "ردیف",
        size: 20,
      },
      {
        accessorKey: "benefitsYear",
        header: "سال",
        size: 20,
      },
      {
      ...
      {
        accessorKey: "benefitsChildrenRights",
        header: "حق اولاد",
        size: 20,
      },
      {
        accessorKey: "editBenefits",
        header: "ویرایش",
        enableSorting: false,
...
export default BaseRetirementBenefitsGrid;
