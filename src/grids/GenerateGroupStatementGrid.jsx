...
function GenerateGroupStatementGrid({
  ...
  const columns = useMemo(
    () => [
      ...
      {
        accessorKey: "statemenrIssueDate",
        header: "تاریخ صدور",
        size: 20,
        Cell: ({ renderedCellValue }) => (
...
export default GenerateGroupStatementGrid;
